package com.geleca.as3.ui.component.data
{
	...
	public class UIDataList extends UIDataView
	{
		...
		public function UIDataList(itemTemplateClass:Class, skin:Class=null) 
		{
		...
		override protected function setup():void 
		{
			...
			if (!_itemTemplateClass)
				_itemTemplateClass = UIItemTemplate;
		...
		public final function clear():void 
		{
			...
			if (length != 0)
			{
				...
				_items 		= new Vector.<UIItemTemplate>();
				dataSource 	= null;
			}
		}
		...
		override protected function bind():void 
		{
			...
			var itemTemplate	:UIItemTemplate;
		...
		public function getItemAt(index:uint):UIItemTemplate
		{
			return _items[index];
		}
		
		public function removeItem(item:UIItemTemplate):UIItemTemplate
		{
		...
		public function get items():Vector.<UIItemTemplate> { return _items; }
